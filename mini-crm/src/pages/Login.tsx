        ...
        <div className="bg-card rounded-xl shadow-lg overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex justify-center items-center gap-2 py-3 px-4 text-sm font-medium rounded-md text-white bg-primary hover:opacity-90 disabled:opacity-50"
            >
              {isLoading ? (
                "Connexion en cours..."
              ) : (
